...
public class PagerFragment extends BaseFragment {
    ...
    public static final String TAG_FRAGMENT = PagerFragment.class.getSimpleName();
    ...
    private static final int DEFAULT_PEEK_HEIGHT = 300;
...
//    protected ViewPager mViewPager;
    ...
    protected ConstraintLayout mControlLayout;
    ...
    * */
    private class AdapterForPages extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case PLAYLIST_PAGE: return getString(R.string.pagePlaylist);
                case EXPLORER_PAGE: return getString(R.string.pageExplorer);
            }
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case PLAYLIST_PAGE: return PlaylistFragment.newInstance();
                case EXPLORER_PAGE: return ExplorerFragment.newInstance();
            }
